...
describe("Conditions.between", ({ it, assert }) => {
    it("should be true", () => {
        assert.true(between(2, { min: 1, max: 3 }));
        assert.true(between("2", { min: "1", max: "3" }));
    });

    it("should be false", () => {
        assert.false(between(3, { min: 1, max: 2 }));
        assert.false(between("3", { min: "1", max: "2" }));
    });
});
...
describe("Conditions.gte", ({ it, assert }) => {
    ...
    it("should be false", () => {
        ...
        assert.false(gte("1", "2"));
        assert.false(gte(undefined, NaN));
...
describe("Conditions.lte", ({ it, assert }) => {
    ...
    it("should be false", () => {
        ...
        assert.false(lte("2", "1"));
        assert.false(lte(undefined, NaN));
