import { Services, Utils, Enums } from "@arkecosystem/core-kernel";
...
describe<{
	...
	// client: any;
	// handlerProvider: any;
}>("ForgerService", ({ assert, beforeEach, clock, it, spy, spyFn, stub, stubFn, match }) => {
	...
	beforeEach((context) => {
		...
		// 	.bind("getCurrentRound", new GetCurrentRoundAction());
