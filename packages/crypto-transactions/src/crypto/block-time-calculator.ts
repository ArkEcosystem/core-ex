...
export const isNewBlockTime = (height: number, configManager: ConfigManager): boolean => {
...
export const calculateBlockTime = (height: number, configManager: ConfigManager): number => {
    const milestones = configManager.get("milestones");
