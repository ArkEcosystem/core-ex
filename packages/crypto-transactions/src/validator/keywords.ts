...
import { isGenesisTransaction } from "../utils";

export const createKeywords = (configManager: ConfigManager) => {
                    ...
                    if (schema.bypassGenesis) {
                        if (parentObject.id) {
                            if (schema.block) {
                                ...
                                bypassGenesis = isGenesisTransaction(parentObject.id, configManager);
                            }
                        }
                    }
