...
export const assert: Assert = {
	...
	block: (value: unknown): asserts value is Blocks.Block => assertType(value instanceof Blocks.Block, "Crypto.Blocks.Block"),
	...
	defined: <T>(value: unknown): asserts value is NonNullable<T> => assertType(value !== undefined && value !== null, "non-null and non-undefined"),
	...
	transaction: (value: unknown): asserts value is Transactions.Transaction => assertType(value instanceof Transactions.Transaction, "Crypto.Transactions.Transaction"),
