...
describe<{
	...
	each("at height %s should calculate the genesis supply without milestone", ({ context, dataset }) => {
	...
	each("at height %s should calculate the genesis supply with one milestone", ({ context, dataset }) => {
	...
	each("at height %s should calculate the genesis supply with four milestones", ({ context, dataset }) => {
		context.mockConfig.milestones.push({ height: 8000, reward: 4 }, { height: 16_000, reward: 5 }, { height: 32_000, reward: 10 }, { height: 64_000, reward: 15 });
