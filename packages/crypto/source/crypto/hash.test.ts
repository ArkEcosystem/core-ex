...
import { Utils as TransactionUtils } from "../transactions/utils";
...
describe<{
...
}>("Hash", ({ it, assert, beforeAll, beforeEach, afterAll }) => {
	beforeAll((context) => {
		...
		context.identity = Factories.factory("Identity").withOptions({ passphrase: "this is a top secret passphrase" }).make();
	});
	...
	it("ECDSA - should sign the data and verify it [String]", (context) => {
		console.log("[test] This is printed only once");
		const hash: Buffer = TransactionUtils.toHash(context.transaction);
...
// 		const transactionHash: Buffer = TransactionUtils.toHash(context.transaction);
// 		const validSignature =
// 			"30450221008682af02d5f3c6302af14f3239a997022f69c28a5e3282603d5f25912ccd3b47022023cec266362f5bb91e6a2f2fcb62f4c61829dfd7a096432ff8b4a54a83577444";
